    ...
    <>
      ...
      <div className={`headVideo  ${ openClose?"open":""} `} id="headVideo">
        ...
        <div className="part2">
          ...
          <p>
            In this lesson, we took a tour through many of the fundamentals you
            need to have in mind before starting your research:
          </p>
          <ul>
            <li>
              We asked the question, what is good UX? And we looked at a number
              of examples of different products and interfaces, while
            ...
            <li>
              We talked about the importance of designing with users in mind and
              to designing with data in mind.
            </li>
          </ul>
          <p>Although we talked a little about research and data in this lesson, we didn't get into many specifics. In the next lesson, we'll discuss UX research in more detail, and you'll get started on the research for your project.
            By now, you should have selected the design topic for your final project. If you haven't settled on a topic yet, you'll want to do that now, since you'll be doing research on that topic in the next lesson.</p>
        <img src="/images/lectureImg.webp" className="lectureImg" alt="lectureImg"/>
        <p>Although we talked a little about research and data in this lesson, we didn't get into many specifics. In the next lesson, we'll discuss UX research in more detail, and you'll get started on the research for your project.
            By now, you should have selected the design topic for your final project. If you haven't settled on a topic yet, you'll want to do that now, since you'll be doing research on that topic in the next lesson.</p>
        </div>
        <div className="part1 ">
