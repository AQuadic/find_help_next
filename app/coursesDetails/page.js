  ...
  <div class="part1">
    <div class="content container">
        <div class="contantAbout">
            ...
            <p>Instructor: <Link href="/instractorInfo">Ahmed Muhammed</Link></p>
        </div>
        <div class="contantCart">
            <h3>Get started today</h3>
            <h4>Start your application or request more information.</h4>
            <Link href="/checkOut" class="btn_page">Apply Now</Link>
            <ul>
                <li>
...
<div class="part3 container">
    <div class="box">
        <img src="/images/details/certificate.webp" class="img_box" alt="certificate"/>
