...
function page() {
  return (
    <>
    <section className="instructor_head instructor_head2 m80">
      ...
      <div className="btn4">
        ...
        <a href="" className="btn_page3">Enroll In Course For $25</a>
      </div>
    ...
    <section className="instructor_about instructor_about2 m80">
      ...
      <section className="instructor_about instructor_about3 container    m80">
        
            <div className="content">
                <div className="part1">
                    <img src="/images/instructorScreen/about2.webp" alt="about1"/>
                </div>
                  <div className="instructor_info">
                    <h3>REQUERMENTS</h3>
                    <h4>
                        No pre-requisites, although experience with working in product or services companies in engineering/project management/program management roles is recommended.                
                    </h4>
      ...
      <section className="container course_Content2 m80">
   
        <div className="course_Content" style={{maxWidth:"760px",margin:"auto"}}> 
            <h2 className="headDetails" >Course Content</h2>
            <h3>6 sections • 32 lectures • 1h 15m total length</h3>
            <div className="all_Course_Content" style={{border:"none"}}>
                <div className="accordion accordion-flush" id="accordionFlushExample2">
                    <div className="accordion-item">
                      ...
                      <div id="flush-collapseOne" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample2">
