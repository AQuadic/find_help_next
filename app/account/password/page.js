        ...
        <div className="account_info personal_info">
          <div className="part1">
            ...
            <ul>
              ...
              <li><Link href="/account/password"  className="active">Password</Link></li>
              <li><Link href="/account/activeSessions">Linked Accounts</Link></li>
          ...
          <div className="Profile">
            ...
            <form className="row g-3 form_page">
              ...
              <div className="col-md-12">
                <label  htmlFor="inputpass2 " className="form-label">New Password</label>
              ...
              <button type="submit" href="" className=" btn_page">Change</button>
            </form>
          </div>
        </div>
      </section>
