   ...
   <div className="part1">
     ...
     <div className="achievement">
       ...
       <div className="part">
         ...
         <h5>150  <span>Trainees</span></h5>
       </div>
       <div className="part">
         <img src="/images/icons/clock.webp" alt="clock"/>
         <h5>150  <span>Hours</span></h5>
       </div>
      </div>
    <div className="aboutME">
     <h3>About me</h3>
     <p>Hello ,i'm Muhammed Ahmed ,UI/UX Designer and ui Developer .I have worked in web interface design and mobile application design .I also worked in the graphic design field for several years.., also worked as an instructor ,, explaining the design approach and user experience.. I have a passion for simplifying the science of design and user experience and presenting it to students in the simplest form.. </p>
    </div>
    </div>
